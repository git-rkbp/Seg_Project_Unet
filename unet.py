...
class UNet_256(nn.Module):
    def __init__(self, n_class = 5):
        ...
        self.d11 = nn.Conv2d(1024, 512, kernel_size=3, padding=1) # After concat: Input: 32x32x1024, Output: 32x32x512
        ...
        self.d21 = nn.Conv2d(512, 256, kernel_size=3, padding=1) # After concat: Input: 64x64x512, Output: 64x64x256
        ...
        self.d31 = nn.Conv2d(256, 128, kernel_size=3, padding=1) # After concat: Input: 128x128x256, Output: 128x128x128
        ...
        self.d41 = nn.Conv2d(128, 64, kernel_size=3, padding=1) # After concat: Input: 256x256x128, Output: 256x256x64
        self.d42 = nn.Conv2d(64, 64, kernel_size=3, padding=1) # Output: 256x256x64

        # Output layer
        # Input: 256x256x64
        self.outconv = nn.Conv2d(64, n_class, kernel_size=1) # Output: 256x256xn_class
